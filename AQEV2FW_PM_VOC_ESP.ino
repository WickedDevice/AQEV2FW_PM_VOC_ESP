...
#define EEPROM_BACKUP_PM10P0_CAL_OFFSET  (EEPROM_BACKUP_MQTT_PASSWORD + 32)
...
void initializeHardware(void) {
    ...
    Serial.println(F(" |       VOC / PM Sensor Suite        |"));
...
void restore(char * arg) {
    ...
    if (strncmp(arg, "defaults", 8) == 0) {
        ...
        eeprom_write_block("aqev2_pm_voc_esp", (void *) EEPROM_UPDATE_FILENAME, 32);
    }
...
boolean publishHeartbeat() {
    ...
    snprintf(scratch, SCRATCH_BUFFER_SIZE-1,
             ...
             "\"converted-value\":%d,"
             "\"firmware-version\":\"%s\","
             "\"publishes\":[\"particulate\",\"voc\",\"temperature\",\"humidity\"%s],"
             "\"counter\":%lu"
